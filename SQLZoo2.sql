/* Exercices from https://sqlzoo.net/wiki/SELECT_from_WORLD_Tutorial
Follow the left navbar and the answers are down below 
*/

/*1) This SQL command show the name, continent and population of all countries */
